 ...
 * File: _coder_ProcessDataWristsQuat_mex.c
 *
...
void mexFunction(int32_T nlhs, mxArray *plhs[], int32_T nrhs,
                 const mxArray *prhs[])
{
  mexAtExit(&ProcessDataWristsQuat_atexit);
  ProcessDataWristsQuat_initialize();
  unsafe_ProcessDataWristsQuat_mexFunction(nlhs, plhs, nrhs, prhs);
 ...
 * Return Type  : void
 */
void unsafe_ProcessDataWristsQuat_mexFunction(int32_T nlhs, mxArray *plhs[1],
                                              int32_T nrhs,
                                              const mxArray *prhs[20])
{
  emlrtStack st = {
  ...
  ProcessDataWristsQuat_api(b_prhs, &outputs);
  /* Copy over outputs to the caller. */
  emlrtReturnArrays(1, &plhs[0], &outputs);
}

/*
 * File trailer for _coder_ProcessDataWristsQuat_mex.c
 *
 * [EOF]
 */
